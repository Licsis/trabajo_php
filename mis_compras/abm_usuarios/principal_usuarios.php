...
<section class="cabecera">
    ...
    <div id="btn-accesos">
        <button onclick="window.location.href='usu_eliminados.php'" class="eliminados">Eliminados</button>
        <button onclick="window.location.href='alta_usu1.php'" class="acceso">Crear usuario</button>
    ...
    <section class="table">
        <table id="form-main">
            ...
            <tbody>
                <?php 
                    $sql1 = "SELECT * FROM usuarios INNER JOIN permisos ON usuarios.id_permiso = permisos.id_permiso WHERE estado_usu = 1 ORDER BY id_usu DESC "; 
                ...
                <tr>
                    ...
                    <td>    
                        <?php   
                            ...
                            echo '<a href="mod_usu1.php?id=' . $code_id . '"> <img class="icono" src="../assets/img/pen-to-square-solid.svg" alt="Modificar usuario"> </a>';
                            echo '<a href="baja_usu.php?id=' . $code_id . '"> <img class="icono" src="../assets/img/trash-solid.svg" alt="Eliminar usuario"> </a>';
